...
**Diperbarui:** 2026-04-29T14:10:34.520548+00:00
**session_id:** `78a4a425`
**persona:** ABOO
...
- **Final (cuplikan):** Brand archetype adalah konsep dalam branding yang mengklasifikasikan merek berdasarkan prototipe karakter psikologis atau stereotip individu. Konsep ini dikembangkan oleh Christopher A. Allen dan Margaret C. Bourdon, dengan pengaruh dari Joseph Campbell's monomyth atau "Hero's Journey" dalam filsafat mythos.

Brand archetype membantu perusahaan memahami identitas merek mereka melalui lensa karakter psikologis yang umum dikenali oleh konsumen. Misalnya, jika merek digambarkan sebagai "hero", maka konsumen akan mengasosiasikan merek tersebut dengan kekuatan dan ketangguhan.

Contoh brand yang menggunakan archetype hero adalah Nike. Nike sering dihubungkan dengan ide-ide seperti kekuatan, keterampilan, dan prestasi. Mereka menonjolkan nilai-nilai ini melalui kampany

## Jawaban akhir (ringkas)

Brand archetype adalah konsep dalam branding yang mengklasifikasikan merek berdasarkan prototipe karakter psikologis atau stereotip individu. Konsep ini dikembangkan oleh Christopher A. Allen dan Margaret C. Bourdon, dengan pengaruh dari Joseph Campbell's monomyth atau "Hero's Journey" dalam filsafat mythos.
