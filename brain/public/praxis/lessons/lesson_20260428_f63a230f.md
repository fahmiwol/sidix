...
**Diperbarui:** 2026-04-28T04:12:09.163812+00:00
**session_id:** `f63a230f`
**persona:** ABOO

## Pertanyaan / tugas pengguna

Apa perbedaan BM25 dan dense retrieval?
...
- **Final (cuplikan):** BM25 dan dense retrieval merupakan kedua teknik dalam ranking dokumen pada sistem pencarian yang berbeda secara prinsip dan mekanisme operasional.

**BM25 (Best Match 25):**
BM25 adalah teknik tradisional yang mengukur relevansi antara pertanyaan pengguna dan dokumen dengan mempertimbangkan beberapa faktor seperti frekuensi kata-kata dalam dokumen, posting, dan iterasi perkembangan dari

## Jawaban akhir (ringkas)

BM25 dan dense retrieval merupakan kedua teknik dalam ranking dokumen pada sistem pencarian yang berbeda secara prinsip dan mekanisme operasional.
