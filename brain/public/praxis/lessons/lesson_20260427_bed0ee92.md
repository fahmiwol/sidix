...
**Diperbarui:** 2026-04-27T14:14:44.134998+00:00
**session_id:** `bed0ee92`
**persona:** ABOO
...
- **Final (cuplikan):** Brand archetype adalah konsep dalam pemasaran yang menggambarkan identitas merek berdasarkan ciri-ciri psikologis atau karakteristik manusia. Konsep ini dikembangkan oleh Christopher A. Jones dan Margaret Mark, di mana mereka memasukkan 12 prototipe (archetype) yang umum ditemui dalam branding.

Archetype merek membantu perusahaan untuk mendefinisikan identitas merek dengan lebih jelas, sehingga pelanggan dapat mengidentifikasi merek tersebut dengan karakteristik tertentu. Misalnya, jika sebuah merek diidentifikasi sebagai "hero," itu berarti merek tersebut secara simbolis menampilkan sifat-sifat heroik seperti keberanian, dedikasi, dan perjuangan.

**Hero Archetype:**
Contoh brand yang menggunakan hero archetype antara lain:

1. **Apple**: Apple sering dianggap sebagai "hero" karena mereka diken

## Jawaban akhir (ringkas)

Brand archetype adalah konsep dalam pemasaran yang menggambarkan identitas merek berdasarkan ciri-ciri psikologis atau karakteristik manusia. Konsep ini dikembangkan oleh Christopher A. Jones dan Margaret Mark, di mana mereka memasukkan 12 prototipe (archetype) yang umum ditemui dalam branding.
