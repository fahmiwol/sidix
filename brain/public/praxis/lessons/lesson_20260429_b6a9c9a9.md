...
**Diperbarui:** 2026-04-29T22:49:28.032057+00:00
**session_id:** `b6a9c9a9`
**persona:** ABOO
...
- **Final (cuplikan):** LoRA, atau Low-Rank Adaptation, adalah teknik yang digunakan dalam fine-tuning model pembelajaran mesin (machine learning) seperti model Bahasa Terbuka (Transformer) untuk membangun model khusus yang dapat menangani task baru atau adaptasi pada data yang berbeda tanpa merusak atau merubah banyak bobot dari model base yang sudah ada.

Prinsip dasar LoRA adalah bahwa sampai sekarang, fine-tuning

## Jawaban akhir (ringkas)

LoRA, atau Low-Rank Adaptation, adalah teknik yang digunakan dalam fine-tuning model pembelajaran mesin (machine learning) seperti model Bahasa Terbuka (Transformer) untuk membangun model khusus yang dapat menangani task baru atau adaptasi pada data yang berbeda tanpa merusak atau merubah banyak bobot dari model base yang sudah ada.
